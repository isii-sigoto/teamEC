...
public interface TblCartMapper {
	 ...
	 */
	@Insert("""
		    	INSERT INTO tbl_cart (user_id, product_id, product_count, created_at, updated_at)
		    	VALUES (#{userId}, #{productId}, #{productCount}, NOW(), NOW())
		    """)
	...
	@Update("""
			UPDATE tbl_cart 
			SET product_count = product_count + #{productCount}, updated_at = now() 
