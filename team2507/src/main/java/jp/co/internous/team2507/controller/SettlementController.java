...
import jp.co.internous.team2507.model.mapper.TblPurchaseHistoryMapper;
 ...
 */
@Controller
@RequestMapping("/team2507/settlement")
public class SettlementController {
	...
	public boolean complete(@RequestBody String destinationId) {
			...
			int userId = loginSession.getUserId();
			int insertedCount = purchaseHistoryMapper.insert(Id, userId);
			...
			return deleteCount == insertedCount;
	}
}
